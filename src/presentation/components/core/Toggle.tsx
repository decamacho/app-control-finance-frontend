...
export function Toggle({ options, value, onChange, tall = false, disabled = false }: ToggleProps) {
  return (
    <div className={`flex p-1 bg-muted rounded-2xl ${disabled ? 'opacity-50 pointer-events-none' : ''}`}>
      {options.map((option) => {
